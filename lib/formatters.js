...
exports.formatRouteName = route => {
  let routeName = 'Route ';
  if (!exports.isNullOrEmpty(route.route_short_name)) {
    routeName += route.route_short_name;
  } else if (!exports.isNullOrEmpty(route.route_long_name)) {
 ...
 * Format stops.
 */
exports.formatStops = (timetable, config) => {
...
exports.formatTimetablePageLabel = timetablePage => {
  ...
  if (timetablePage.consolidatedTimetables && timetablePage.consolidatedTimetables.length > 0) {
    ...
    const timetablePageLabel = routes.map(route => exports.formatRouteName(route));
 ...
 */
exports.mergeTimetablesWithSameId = timetables => {
