...
exports.generateHTML = function(agencyKey, timetableId, options, cb) {
  ...
  gtfs.getTimetable(agencyKey, timetableId, function(e, timetables) {
    if(e) return cb(e);
    ...
    var timetable = timetables[0].toObject();
    ...
    gtfs.getCalendars(agencyKey, startDate, endDate, timetable.monday, timetable.tuesday, timetable.wednesday, timetable.thursday, timetable.friday, timetable.saturday, timetable.sunday, function(e, calendars) {
      ...
      function processRoutes(e, routeTrips) {
        ...
        var trips = _.flatten(routeTrips, true);
        ...
        function processStops(e, trips) {
          ...
          gtfs.getStops(agencyKey, _.pluck(stops, 'stop_id'), function(e, stopDatas) {
            ...
            gtfs.getCalendarDatesByService(serviceIds, function(e, calendarDates) {
              ...
              var excludedDates = _.uniq(filterCalendarDates(_.pluck(calendarDates['2'], 'date'), timetable.start_date, timetable.end_date)).sort();
              var includedDates = _.uniq(filterCalendarDates(_.pluck(calendarDates['1'], 'date'), timetable.start_date, timetable.end_date)).sort();
        ...
        gtfs.getTimetableStopOrders(agencyKey, timetable.timetable_id, function(e, timetableStopOrders) {
          if(e) return cb(e);
      ...
      async.map(timetables, function(timetable, cb) {
        gtfs.getRoutesById(agencyKey, timetable.route_id, function(e, route) {
          if(e) return cb(e);
