 ...
 */
exports.warn = text => {
  process.stdout.write(`\n${chalk.yellow.underline('Warning')}${chalk.yellow(':')} ${chalk.yellow(text)}\n`);
};
 ...
 */
exports.error = text => {
  process.stdout.write(`\n${chalk.red.underline('Error')}${chalk.yellow(':')} ${chalk.red(text)}\n`);
};

/*
 * Function to print a table of stats to the console.
 */
