...
GTFS-to-HTML includes a default template for generating HTML timetables in [`views/timetable`](https://github.com/BlinkTagInc/gtfs-to-html/tree/master/views/timetable). It is built using [pug](https://pugjs.org/). 

You can create your own template using the default one as a starting point.

* Copy the `views/timetable` folder to `views/custom/myagency`.
* Modifiy as needed.
